...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.custom((t) => (
                <CustomToast t={t} message="Registration Successful! Please check your email." type="success" />
            ), { duration: 3000 });

            // Redirect to login after distinct delay
            setTimeout(() => {
                navigate('/login');
            }, 2000);
            ...
            toast.custom((t) => (
                <CustomToast t={t} message={err.message || 'Registration failed'} type="error" />
            ), { duration: 3000 });
        } finally {
            setIsLoading(false);
        }
                ...
                <div className="w-full max-w-md space-y-8 animate-fade-in-up">
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-2 text-sm text-teal-100">
                            Join us to start monitoring jeepney seats.
                        </p>
                    </div>
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="group">
                                    <label htmlFor="firstName" className="block text-sm font-semibold text-teal-50 mb-1 transition-colors group-focus-within:text-white">
                                        First Name
                                    </label>
                                    <input
                                        id="firstName"
                                ...
                                <div className="group">
                                    <label htmlFor="lastName" className="block text-sm font-semibold text-teal-50 mb-1 transition-colors group-focus-within:text-white">
                                        Last Name
                                    </label>
                                    <input
                                        id="lastName"
                            ...
                            <div className="group">
                                <label htmlFor="email" className="block text-sm font-semibold text-teal-50 mb-1 transition-colors group-focus-within:text-white">
                                    Email Address
                                </label>
                                <input
                                    id="email"
                            ...
                            <div className="group">
                                <label htmlFor="password" className="block text-sm font-semibold text-teal-50 mb-1 transition-colors group-focus-within:text-white">
                                    Password
                                </label>
                                <input
                                    id="password"
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                ...
                                <a href="/login" className="font-semibold text-white hover:text-teal-200 transition-colors flex items-center justify-center gap-2 group">
